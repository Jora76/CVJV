...
private:
	...
	enum LigneTxt {coordonneesPremiereCase = 4, comp = 20, boutonGrille = 21, checkPoint = 22, arrivee = 23, obstacle = 24, depart = 25, faille = 26, interrupteur = 27, ligneSuivante = 28, fin = 29};
